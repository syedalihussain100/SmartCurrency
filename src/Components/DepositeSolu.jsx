    ...
    <>
      ...
      >
        <div className="card-body p-2-1">
          <img src={Image} alt="logo" className="app_set_recharge_item_logo" />
          ...
          <div className="app_recharge_order_info text-nowrap">
            ...
            <div>
              <div
                ...
                style={{ fontSize: "1.2rem",padding:"3px 0px" }}
              >
                Recharge currency
              </div>
              <div
