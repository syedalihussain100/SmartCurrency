        ...
        <div className="content-body position-relative">
          ...
          >
            <InputLabel htmlFor="outlined-adornment-password">
              Please enter the original security password
            </InputLabel>
            <OutlinedInput
              ...
              label="Please enter the original security password
              "
            />
          </FormControl>
          ...
          >
            ...
            <OutlinedInput
              ...
              label="              Please enter a new security password
              "
            />
          </FormControl>
          ...
          >
            <InputLabel htmlFor="outlined-adornment-password">
              Please enter new security password again
            </InputLabel>
            <OutlinedInput
              id="outlined-adornment-password"
              type={showPassword ? "text" : "password"}
              ...
              label="                            Please enter new security password again
